...
```{r fig-awards, fig.width = 7.5, fig.height = 4.5, echo = FALSE, message = FALSE}
library(ggplot2)
...
ggplot(d6, aes(year, obligation_net / 1e6)) +
  ...
  labs(x = NULL, y = "net obligations ($M)",
       ...
       subtitle = "Bars below zero are claw-backs booked as posted") +
  theme_minimal(base_size = 10)
```

### 8.7 The top 20 awards

```{r fig-top20, fig.width = 7.5, fig.height = 5, echo = FALSE}
...
```{r fig-trend, fig.width = 7.5, fig.height = 4, echo = FALSE}
